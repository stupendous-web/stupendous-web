          ...
          <Box w={["100%", "25%"]} p={4}>
            {step === 0 && (
              <>
                ...
                <Text>
                  Kickstart your project with a consultation. Use the form below
                  to request an estimate. You&apos;ll receive it right to your
                  inbox in just a few hours.
                </Text>
              ...
              <>
                ...
                <form onSubmit={(event) => handleSubmit(event)}>
                  <FormControl>
                    ...
                    <FormLabel>
                      Is there anything you&apos;d like me to know about you or
                      what you do? Or, do you have any special needs?
                    </FormLabel>
                    <Textarea
                      value={note}
